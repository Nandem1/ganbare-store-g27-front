    ...
    <Container fluid className='hero-bg w-100 h-100 d-flex justify-content-between align-items-center'>
      <div className="carousel-container">
        <div className="carousel-inner-mobile">
          <div className='bgHeroImg slide-mobile'><Image src='https://raw.githubusercontent.com/Nandem1/ganbare-store-g27-front/main/src/assets/hero/bg1.jpg' /></div>
          <div className='bgHeroImg slide-mobile'><Image src='https://raw.githubusercontent.com/Nandem1/ganbare-store-g27-front/main/src/assets/hero/bg2.jpg' /></div>
          <div className='bgHeroImg slide-mobile'><Image src='https://raw.githubusercontent.com/Nandem1/ganbare-store-g27-front/main/src/assets/hero/bg3.jpg' /></div>
        </div>
      </div>
    </Container>
  );
